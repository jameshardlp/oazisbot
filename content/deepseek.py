...
def generate_caption_with_validation() -> Tuple[str, Optional[str]]:
    ...
    for attempt in range(max_attempts):
        try:
            ...
            # Если пост длиннее 700, но меньше 720 - оставляем
